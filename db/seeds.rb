...
contractor1 = Contractor.create(name: "Toby Merlet", email: "toby@gmail.com", password: "password", password_confirmation: "password", available_now: true, distance_travel: 50000, phone: "0131-346-0089", role: "User")
...
contractor2 = Contractor.create(name: "Gareth Joseph", email: "gareth@gmail.com", password: "password", password_confirmation: "password", available_now: true, distance_travel: 500, phone: "0108-643-0900", role: "User")
...
contractor3 = Contractor.create(name: "Johana Petrie", email: "johana@gmail.com", password: "password", password_confirmation: "password", available_now: true, distance_travel: 200, phone: "0131-346-0089", role: "User")
...
contractor4 = Contractor.create(name: "David Blain", email: "david@gmail.com", password: "password", password_confirmation: "password", available_now: true, distance_travel: 500, phone: "0108-643-0900", role: "User")
...
contractor5 = Contractor.create(name: "Graham Curl", email: "graham@gmail.com", password: "password", password_confirmation: "password", available_now: true, distance_travel: 50000, phone: "0131-346-0089", role: "User")
...
contractor6 = Contractor.create(name: "Andrew Henning", email: "andrew@gmail.com", password: "password", password_confirmation: "password", available_now: true, distance_travel: 500, phone: "0108-643-0900", role: "User")
...
contractor7 = Contractor.create(name: "Gwenn Frame", email: "gwenn@gmail.com", password: "password", password_confirmation: "password", available_now: true, distance_travel: 5000, phone: "0131-346-0089", role: "User")
...
contractor8 = Contractor.create(name: "James Macdonald", email: "james@gmail.com", password: "password", password_confirmation: "password", available_now: true, distance_travel: 200, phone: "0108-643-0900", role: "User")
...
contractor9 = Contractor.create(name: "Liam Grant", email: "liam@gmail.com", password: "password", password_confirmation: "password", available_now: true, distance_travel: 500, phone: "0131-346-0089", role: "User")
...
contractor10 = Contractor.create(name: "Sam Hayes", email: "sam@gmail.com", password: "password", password_confirmation: "password", available_now: true, distance_travel: 50000, phone: "0108-643-0900", role: "User")
...
contractor11 = Contractor.create(name: "Tobias Green", email: "tobias@gmail.com", password: "password", password_confirmation: "password", available_now: true, distance_travel: 500, phone: "0131-346-0089", role: "User")
...
contractor12 = Contractor.create(name: "Eduardo Cordova", email: "eduardo@gmail.com", password: "password", password_confirmation: "password", available_now: true, distance_travel: 200, phone: "0108-643-0900", role: "User")
...
employee1 = Employee.create(name: "Mike Martin", email: "mike@gmail.com", password: "password", password_confirmation: "password", role: "User")
